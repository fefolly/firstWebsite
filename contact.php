      ...
      <tr>
        <td colspan="2" valign="top"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top:#FFFFFF 2px solid;">
          <tr>
            ...
            <td width="708" bgcolor="#EABE94"><pre class="menu"><a href="index.php">Acceuil</a>                  <a href="proposN.php">A propos de Nous</a>                  <a href="proposN.php">Services</a>                  <a href="reservation.php">R&eacute;servation</a>                  <a href="proposN.php">Actualité</a>                  <a href="contact.php">Contacts</a></pre></td>
  ...
  <tr>
	...
	<table width="94%" height="14" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		<div class="body1" style="padding:8px;"><strong>25 Septembre 2012</strong><br />
In feugiat. Sed et turpis ac risus aliquet . Nam cursus  lobortis.<br />
<br />
          <a href="#"><strong>Voir plus</strong></a></div>
...
<br />
          <a href="#"><strong>Voir plus</strong></a></div>
		  <div class="body1" style="padding:8px;"><strong>04 Septembre 2012</strong><br />
In feugiat. Sed et turpis ac risus aliquet rhoncus nam cursus.<br />
<br />
          <a href="#"><strong>Voir plus</strong></a></div>
		</td>
