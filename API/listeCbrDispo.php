          ...
          <tr>
			...
			<div style="padding-left:5px;"><form id="form1" name="form1" method="post" action="" style="margin:auto;">
              <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
                ...
                <tr>
                  <td align="left" valign="top"><label>
                    <center><input type="submit" name="lui" value="V&eacute;rifier disponibilit&eacute;"/></center>
                  </label></td>
                </tr>
              </table>
                        </form></div>			</td>
      ...
      <td>
         <table>
           <tr>
            ...
            <td width="708" bgcolor="#EABE94"><pre class="menu"><a href="reserv.php">Acceuil</a>                <a href="listeCbrDispo.php">Chambres</a>                <a href="contact.php">Vos informations</a></pre></td>
            <td width="11" align="right" valign="top" bgcolor="#EABE94"><img src="images/index_34.gif" width="11" height="38" alt="" /></td>
          </tr>
           </table>
    <center>
        <center><p><h3>Liste des chambres disponibles pr&eacute;sentement</h3></p></center>
    
     <table border=1>
            <tr><th>Type de chambre</th><th>Prix de la chambre</th><th>Nombre de place</th><th>Action</th></tr>
            <?php 
...
?>
  ...
  <tr>
    <td width="780" align="right" valign="top" bgcolor="#EABE94"><img src="images/index_34.gif" width="11" height="38" alt="" border="solid"/></td>
